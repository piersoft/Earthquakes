	...
	*/
	...
	var dataLayer = new L.DataLayer(data,{
		...
		onEachRecord: function (layer, record, location) {
			...
			var magString = record.properties.Magnitude.toFixed(1);
			var numChars = magString.length;
			var fontSize = fontSizeFunction.evaluate(record.properties.Magnitude);
...
$(document).ready(function() {
	...
	var baseLayer = L.tileLayer('http://{s}.tile.cloudmade.com/82e1a1bab27244f0ab6a3dd1770f7d11/999/256/{z}/{x}/{y}.png', {
	    attribution: 'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery <a href="http://cloudmade.com">CloudMade </a>Data from <a href="http://http://openmap.rm.ingv.it/gmaps/rec/Index.htm">INGV</a> @Piersoft'
	});
